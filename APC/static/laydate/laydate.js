...
;!function () {
    ...
    var e = window.layui && layui.define, t = {
        ...
        }, i = "laydate", r = ".layui-laydate", o = "layui-this", s = "laydate-disabled", l = "The start date exceeds the end date<br>Suggest reselect",
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        }), w(f[0]).attr("lay-ym", l.year + "-" + (l.month + 1)), w(f[1]).attr("lay-ym", l.year + "-" + (l.month + 1)), "cn" === s.lang ? (w(f[0]).attr("lay-type", "year").html(l.year + "年"), w(f[1]).attr("lay-type", "month").html(l.month + 1 + "month")) : (w(f[0]).attr("lay-type", "month").html(m.month[l.month]), w(f[1]).attr("lay-type", "year").html(l.year)), u && (s.range && (e ? r.endDate = r.endDate || {
